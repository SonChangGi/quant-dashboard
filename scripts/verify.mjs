...
assert(contains(files.app, 'SOX 구성종목 · 가격 vs 실적'), 'SOX central summary panel copy exists');
...
assert(contains(files.app, '최근 1개월 편입비중'), 'ETF Tracking chart copy names the one-month history window');
