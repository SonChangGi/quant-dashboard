...
- Preserve evidenced domain meaning and useful existing interactions.
- Test only applicable loading, empty, degraded, error, offline, or recovery
  states.
- Verify the layouts, input methods, accessibility behavior, themes, and
