...
3. In this source package, `<quant-research-suite>/shared/references/web-design-v2.4.1.md`.
4. In a local installation, `<installed-skills-root>/quant-research-shared/references/web-design-v2.4.1.md`.
...
- SHA-256: `dee11da0061b943ef04a8516ffb9811735571ff464c9a81bd8950cb3b6ee516e`
